...
- `[MEMBERS]`:
  - Member A: Kim Hong Giang | Role: Logging & PII
  - Member B: Kim Hong Giang | Role: Tracing & Enrichment
  - Member C: Kim Hong Giang | Role: SLO & Alerts
  - Member D: Kim Hong Giang | Role: Load Test & Incident Injection
  - Member E: Kim Hong Giang | Role: Dashboard & Evidence
  - Member F: Kim Hong Giang | Role: Blueprint & Demo Lead
...
### 3.1 Logging & Tracing
- `[EVIDENCE_CORRELATION_ID_SCREENSHOT]`: [screenshots/correlation-id.png](screenshots/correlation-id.png)
- `[EVIDENCE_PII_REDACTION_SCREENSHOT]`: [screenshots/pii-redaction.png](screenshots/pii-redaction.png)
- `[EVIDENCE_TRACE_WATERFALL_SCREENSHOT]`: [screenshots/trace-waterfall.png](screenshots/trace-waterfall.png)
...
### 3.2 Dashboard & SLOs
- `[DASHBOARD_6_PANELS_SCREENSHOT]`: [screenshots/dashboard-6panels.png](screenshots/dashboard-6panels.png)
- `[SLO_TABLE]`:
...
### 3.3 Alerts & Runbook
- `[ALERT_RULES_SCREENSHOT]`: [screenshots/alerts.png](screenshots/alerts.png)
...
- `[SYMPTOMS_OBSERVED]`: `/metrics` shows P95 latency spike from 152ms to >2500ms. Langfuse traces show `retrieve()` span taking 2500ms.
...
### D. Kim Hong Giang (Load Test & Incident Injection)
- `[TASKS_COMPLETED]`:
...
### E. Kim Hong Giang (Dashboard & Evidence)
- `[TASKS_COMPLETED]`:
...
### F. Kim Hong Giang (Blueprint & Demo Lead)
- `[TASKS_COMPLETED]`:
